...
import tata.reader.mycomponent.MyStreamReaderImpl
import tata.transformer.mycomponent.MyStreamTransformerImpl
import tata.writer.mycomponent.MyStreamWriterImpl
